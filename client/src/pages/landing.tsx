  ...
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4">
        <div className="max-w-2xl text-center py-10 md:py-16 space-y-5">
          ...
          <Button size="lg" asChild className="w-full sm:w-auto text-base" data-testid="button-login-hero">
            <a href="/api/login">Comenzar ahora</a>
          </Button>
        </div>

        <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-3 gap-3 pb-10 md:pb-16">
